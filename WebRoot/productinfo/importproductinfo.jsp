...
<html>
  <head>
    ...
    <title>--IMPORT PRODUCT-INFO FROM EXCEL--</title>
  	...
  	<div class="row">
  		<div class="panel panel-info">
  			...
  			<div class="panel-body">
	   			<s:form action="importproductinfos" namespace="/productinfo" cssClass="form-horizontal" method="post" theme="simple" enctype="multipart/form-data">
